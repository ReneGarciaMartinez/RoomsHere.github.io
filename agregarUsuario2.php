...
<?php }else{?>
  <form action="userController.php" method="POST" class="pb-5">
  <div class="form-row">
  ...
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label >Usuario</label>
      <input type="text" class="form-control" name="User_u" maxlength="15" required>
    </div>
  </div>
  <div class="form-row">
    <div class="col-md-4 mb-3">
      <label >Contraseña</label>
      <input type="password" class="form-control"  name="pass_u" maxlength="15" required>
    </div>
  </div>
